...
export default function Home() {
  return (
    <>
      <section className="hero mx-auto h-screen relative flex-1  flex flex-col justify-center lg:justify-between px-6 py-6">
        ...
        <div className="flex flex-col items-center">
          <div className="w-96 h-96 item-center rounded-full border-[15px] border-blue-600 flex fle-col justify-center items-center max-sm:w-56 max-sm:h-56 px-40 py-40">
            <div className="w-96 w h-96 item-center rounded-full border-[20px] border-blue-600 blur-lg max-sm:w-56 max-sm:h-56 px-40 py-40"></div>
          </div>
        </div>
